...
<body class="pkp_page_{$requestedPage|escape} pkp_op_{$requestedOp|escape}">
	...
	<script type="text/javascript">
		{literal}
			$(document).ready(function() {
				PDFJS.workerSrc='{/literal}{$pluginUrl}/pdf.js/viewer/build/pdf.worker.js{literal}';
	...
	<div id="pdfCanvasContainer" class="galley_view">
		<iframe id="pdfIframe" src="{$pluginUrl}/pdf.js/viewer/web/viewer.html?file={$pdfUrl|escape:"url"}" width="100%" height="100%" style="min-height: 500px;" allowfullscreen webkitallowfullscreen></iframe>
		<script type="text/javascript">
			{literal}
			document.getElementById('pdfIframe').contentWindow.hypothesisConfig = function () {
				return {
					"openSidebar": true,
					services: [{
						apiUrl: '{/literal}{url router=$smarty.const.ROUTE_PAGE page="hypothesisApi" op="api"}{literal}',
